...
payload.forEach((x) => {
  target.innerHTML += `
    <div class="speaker">
                      <div class ="${x.modal.speakernumber}">
                        <div class="imagecont">
